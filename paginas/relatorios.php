    ...
    <main>
        ...
        <div id="relatorios-section" class="section">
            <div class="card">
              ...
              <div id="TitleCard" style="margin-bottom: 15px;">
                <h3>Relatórios</h3>
              </div>
    
              <h3 style="margin-bottom:10px;">Disponíveis para gerar:</h3>
              ...
              <div class="content-box">
                <div class="cadastro-grid">
                  ...
                  <a style="text-decoration: none;" href="#">
                    <div style="text-align: center;" class="relatorio">
                      <div> <svg style="height: 40px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                          <path
                  ...
                  <a style="text-decoration: none;" href="#">
                    <div style="text-align: center;" class="relatorio">
                      ...
                      <span>Peças paradas estoque</span>
                    </div>
                  </a>
